...
person.birthday = new Date(1994, 1, 11); // 11 - Jan - 1994
...
function getAge(birthday) {
    ...
    var edad = dia_act .getFullYear() - birth.getFullYear();
    var mes = dia_act .getMonth() - birth.getMonth();
    if (mes < 0 || (mes === 0 && dia_act .getDate() < birth.getDate()))
 {
        edad--;
    } return edad;
}
